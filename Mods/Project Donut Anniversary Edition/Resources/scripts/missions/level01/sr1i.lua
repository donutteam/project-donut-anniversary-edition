...
Game.SelectMission("sr1")
	...
	DerbyStage("bart",    1, "light_v", "sr1_light_carstart",    "gen\\l1sr1_light.con",		"bart", true)
 
	DerbyStage("apu",     2, "apu_v",   "sr1_longhorn_carstart", "gen\\l1sr1_apu.con",   		"apu")

	DerbyStage("moleman", 3, "cBone",   "sr1_bone_carstart",     "gen\\l1sr1_bonestorm.con",   	"moleman")

	DerbyStage("marage",  4, "marge_v", "sr1_marge_carstart",    "gen\\l1sr1_marge.con", 		"m_prison")
