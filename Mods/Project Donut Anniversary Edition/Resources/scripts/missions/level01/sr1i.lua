...
Game.SelectMission("sr1")
	...
	DerbyStage("bart",    1, "light_v", "sr1_light_carstart",    "missions\\level01\\sr1\\lig_v.con", "bart", true)
	...
	DerbyStage("marage",  4, "marge_v", "sr1_marge_carstart",    "missions\\level01\\sr1\\mrg_v.con", "m_prison")
