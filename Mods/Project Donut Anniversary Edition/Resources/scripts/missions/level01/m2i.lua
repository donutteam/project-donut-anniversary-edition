Game.SelectMission("m2")
	...
	Game.AddStage(3)
		...
		Game.SetStageTime(({ 16, 8 })[Settings.MissionDifficulty])
	...
	Game.AddStage(0)
		...
		Game.SetStageTime(({ 24, 12 })[Settings.MissionDifficulty])
	...
	Game.AddStage()
		...
		Game.SetStageTime(({ 20, 10 })[Settings.MissionDifficulty])
	...
	Game.AddStage()
		...
		Game.SetStageTime(({ 32, 16 })[Settings.MissionDifficulty])
	...
	Game.AddStage(0)
		...
		Game.SetStageTime(({ 40, 20 })[Settings.MissionDifficulty])
	...
	Game.AddStage(18)
		...
		Game.SetStageTime(({ 60, 30 })[Settings.MissionDifficulty])
