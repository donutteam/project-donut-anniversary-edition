Game.SelectMission("sr3")
	...
	Game.AddStage(0)
		...
		Game.SetStageAIRaceCatchupParams("honor_v", 100, 0.6, 1.0, 1.75)

		Game.AddStageVehicle("apu_v","sr3_AI_carstart4","target`","Missions\\level01\\sr3_2nd.con","apu")
		Game.SetStageAIRaceCatchupParams("apu_v", 80, 0.6, 0.9, 1.25)

		Game.AddStageVehicle("hype_v","sr3_AI_carstart3","target","Missions\\level01\\sr3_3rd.con","moleman")
		Game.SetStageAIRaceCatchupParams("hype_v", 80, 0.6, 0.9, 1.25)

		Game.AddStageVehicle("cPolice","sr3_AI_carstart1","race","Missions\\level01\\sr3_1st.con","jimbo")
